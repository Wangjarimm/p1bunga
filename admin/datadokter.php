                                ...
                                <tbody>
                                    ...
                                    <?php while ($dokter = mysqli_fetch_assoc($query)) : ?>
                                        <tr>
                                            ...
                                            <?php endif; ?>
                                            <td>
                                                <a href="editdokter.php?id=<?= $dokter['id']; ?>" class="btn btn-warning">Edit</a> |
                                                <a href="deletedokter.php?id=<?= $dokter['id']; ?>" class="btn btn-danger" onclick="return confirm('Yakin mau di hapus?')">Hapus</a> |
                                                <?php if ($dokter['ruangan'] !== null) : ?>
                                                    <a href="editjadwal.php?id=<?= $dokter['id_jadwal']; ?>" class="btn btn-primary">Edit Jadwal</a>
                                                <?php else : ?>
                                                    <a href="jadwaldokter.php?id=<?= $dokter['id']; ?>" class="btn btn-success">Jadwal</a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <?php $i++; ?>
