...
$dokter = query("SELECT id,nama FROM dokter WHERE id = $id")[0];

if (isset($_POST["submit"])) {

    if (jadwalDokter($_POST) > 0) {
        echo
        "<script>
        ...
        echo
        "<script>
                alert('Jadwal Dokter gagal ditambahkan :( ');
        </script>";
    }
}
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Tambah Jadwal Dokter</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Tambah Jadwal Dokter</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="container p-4">
                            <form method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="time" class="form-control" id="exampleInputPassword1" name="jam">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputPassword2" class="form-label">Ruangan</label>
                                    <input type="text" class="form-control" id="exampleInputPassword2" name="ruangan">
                                </div>
