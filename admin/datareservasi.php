...
$query = mysqli_query($connect,"SELECT p.*,p.id AS id_pasien, u.*,a.*,d.nama,d.spesialis,j.* FROM pasien p INNER JOIN users u ON p.id_user = u.id_user INNER JOIN antrian a ON a.id_pasien = p.id INNER JOIN dokter d ON p.id_dokter = d.id INNER JOIN jadwal_dokter j ON j.id_dokter = d.id");
...
// Fungsi untuk menghasilkan baris tabel dalam HTML
...
// Panggil fungsi jika tombol unduh PDF diklik
if (isset($_POST['download_pdf'])) {
    generatePDF(mysqli_fetch_all($query, MYSQLI_ASSOC));
}
?>
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="post">
                                <button type="submit" class="btn btn-primary mb-3" name="download_pdf">Unduh PDF</button>
                            </form>
