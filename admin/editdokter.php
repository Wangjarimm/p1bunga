                        ...
                        <div class="container p-4">
                            <form method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="nama_dokter" value="<?= $dokter['nama']; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">Spesialis</label>
                                    <input type="text" class="form-control" id="exampleInputPassword1" name="spesialis" value="<?= $dokter['spesialis']; ?>">
                                </div>
